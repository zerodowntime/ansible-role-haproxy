...
Ansible role to install and configure HA-Proxy,
HA-Proxy is a TCP/HTTP reverse proxy
...
| haproxy__global_maxconn                  |    yes    |  int   | Decifies the maximal number of concurrent connections that will be sent to all servers                     |
...
| haproxy__default_default_server          |    no     | string | defaulkt options added to servers definintions                                                             |
| haproxy__default_error_file              |    no     |  dict  | list of defaults error files                                                                               |
| haproxy__default_options                 |    no     |  list  | list of options in default desctions                                                                       |
| haproxy__default_crt_base                |    no     | string | default path to certyficates                                                                               |
...
| haproxy__ssl_files                       |    no     |  dict  | list of certyficate to upload                                                                              |
...
| haproxy__chroot        | string | path to chroot enviroment |
